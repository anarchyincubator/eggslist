...
class GoogleSocialManager(SocialAuthManager):
    ...
    def __init__(self):
        ...
        self.client_secret = settings.GOOGLE_SECRET_KEY
        self.redirect_url = (
            f"{settings.SITE_URL}/{settings.GOOGLE_AUTH_REDIRECT_URL}"
        )
        self.scope = settings.GOOGLE_OAUTH_SCOPE
        super().__init__()
...
class FacebookSocialManager(SocialAuthManager):
    ...
    def __init__(self):
        ...
        self.client_secret = settings.FACEBOOK_SECRET_KEY
        self.redirect_url = (
            f"{settings.SITE_URL}/{settings.FACEBOOK_AUTH_REDIRECT_URL}"
        )
        self.scope = settings.FACEBOOK_OAUTH_SCOPE
        super().__init__()
